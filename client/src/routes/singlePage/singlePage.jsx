...
//   const [isOccupied, setIsOccupied] = useState(post?.status === true);
...
//                   className={`button ${isOccupied ? "Occupied" : "NOccupied"}`} // Use conditional class
//                   style={{
//                     backgroundColor: isOccupied ? "#fece51" : "white",
//                   }}
//                 >
//                   <img
//                     src={isOccupied ? "/occupied.png" : "/notOccupied.png"}
//                     alt=""
//                   />
        ...
        <div className="wrapper">
          ...
          <div className="sizes">
            <div className="size">
              ...
              <span>
                {renderNotGiven(
                  post.postDetail?.size ? `${post.postDetail.size} sqft` : null
                )}
              </span>
            </div>
            <div className="size">
